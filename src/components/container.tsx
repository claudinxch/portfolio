...
export const Container = ({ className, ...props }: ContainerProps) => {
  ...
  return (
    <section
      className={`w-[calc(100% - 300px)] relative flex flex-col overflow-y-scroll overflow-x-hidden h-dvh p-3 font-inter transition-colors duration-500 lg:overflow-hidden lg:pb-4 lg:p-8 xl:px-12 xl:pl-20  ${
        className || ''
