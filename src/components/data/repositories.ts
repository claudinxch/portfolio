...
export const repositories: Array<RepositoriesInterface> = [
  {
    title: 'Starflix',
    description:
      'Starflix is your go-to website for movies currently in theaters, upcoming movie releases, and the best-rated films, all in one place. Plus, you can save your favorite movies directly to your local storage and visit them anytime!',
  ...
  },
  {
    title: 'Weather Now',
    description:
      'This application provides real-time weather updates, displaying the temperature, wind speed, and humidity percentage for any location in the world. With its user-friendly interface, you can easily check the current weather conditions.',
