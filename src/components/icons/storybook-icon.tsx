...
export const StorybookIcon = ({ width, strokeColor }: IconsInterface) => {
  return (
    <div className="relative">
      ...
      <p className="opacity-0 absolute -left-2.5 -top-9 p-1 px-2 text-sm text-[#121212] font-medium bg-gradient-to-r from-[#EC4899] to-[#8B5CF6] rounded transition duration-200 group-hover:opacity-100">
        Storybook
      </p>
    </div>
  )
